...
API_UPLOAD = "https://fintech-expense-auditor-1.onrender.com/api/upload-receipt"
API_CLAIMS = "https://fintech-expense-auditor-1.onrender.com/api/claims"
API_UPDATE = "https://fintech-expense-auditor-1.onrender.com/api/update-claim"
...
if view_mode == "Employee Portal" or not st.session_state.is_admin:
    ...
    if st.session_state.employee_name is None:
        ...
        with tab_history:
            ...
            try:
                res = requests.get(f"https://fintech-expense-auditor-1.onrender.com/api/my-claims/{st.session_state.employee_id}")
